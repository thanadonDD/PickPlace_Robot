...
\begin{table}[H]
    ...
    \begin{tabular}{llcc p{5cm}}
        ...
        Proximity sensor PR12-2DN  & 12V & 0.2 A & 2.4 W & ประมาณตาม Solenoid ทั่วไป \\
        Margin Safety 10\% & - & 0.56 A & 13.20 W & บวกเพิ่ม 10\% ของกระแสรวม (5.6 A) \\
        \midrule
        \textbf{รวม 24V Bus} & \textbf{24V} & $\approx\textbf{6.16 A}$ & $\approx\textbf{145.20 W}$ & \textbf{เพียงพอ (PSU 24V/10A = 240W)} \\
        \bottomrule
    \end{tabular}
\end{table}

ค่ากระแสรวมบน 24V Bus อยู่ที่ประมาณ 6.16 A ซึ่งน้อยกว่าพิกัดของ PSU 24V/10A (240W) อยู่มาก มีกำลังเหลือ Margin ประมาณ 39.5\%
...
\begin{table}[H]
    ...
    \begin{tabular}{llcc p{5cm}}
        ...
        Opto Module x4 & 5V & 0.08 A & 0.40 W & ประมาณ 20 mA ต่อชุด \\
        Relay Module X5 & 5V & 0.50 A & 2.50 W & Coil 5V \\
        Selector Switch & 5V & 0.01 A & 0.05 W & ไม่มีนัยสำคัญ \\
        Margin Safety 10\% & 5V & 0.169 A & 0.845 W & บวกเพิ่ม 10\% ของกระแสรวม (1.69 A) \\
        \midrule
        \textbf{รวม 5V Bus} & \textbf{5V} & $\approx\textbf{1.86 A}$ & $\approx\textbf{9.30 W}$ & \textbf{เพียงพอ (PSU 5V/5A = 25W)} \\
        \bottomrule
    \end{tabular}
\end{table}

ค่ากระแสรวมบน 5V Bus อยู่ที่ประมาณ 1.86 A ซึ่งน้อยกว่าพิกัดของ PSU 5V/5A (25W) มีกำลังเหลือ Margin ประมาณ 62.8\%
...
\begin{table}[H]
    ...
    \begin{tabular}{lcccc}
        ...
        \midrule
        PSU 24V/10A & 240 W & 145.20 W & 39.5\% & PASS \checkmark \\
        PSU 5V/5A & 25 W & 9.30 W & 62.8\% & PASS \checkmark \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccl}
    ...
    \midrule
    AC Input -- 24V Branch & 8.02 & 10.02\,A & 10.5\,A \\
    DC 24V -- Motor Branch & 6.16 & 7.70\,A & 8\,A \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{3.5cm} p{4.5cm} cc}
        ...
        \midrule
        AC Input 24V Branch & ประมาณ 8.02 A (คำนวณจาก Power 145.20W) & 10.02 A & 10.5 A \\
        DC 24V Motor Branch & 5 A & 6.25 A & 6.5 A \\
        DC 5V-Logic Branch & 1.86 A & 2.32 A & 2.5 A \\
        \bottomrule
    \end{tabular}
\end{table}
...
Optocoupler Module, Relay Module, Encoder Connector,Gripper interface, ไฟเลี้ยงบอร์ด 5V และ CAN Bus
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    % เอา width=\textwidth ออก กำหนดเฉพาะความสูงอย่างเดียว
    \includegraphics[height=4.5cm]{images/pcb_layout.png}
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    % กำหนดความสูงให้เท่ากันเป๊ะกับรูปแรก
    \includegraphics[height=4.5cm]{images/pcb_3d.png}
...
E-Stop ทำงานในระดับ Hardware โดยตรงผ่าน Contactor 
เพื่อตัดไฟมอเตอร์ โดยมีการส่งสัญญาณไปให้ 
STM32 รับรู้ เพื่อส่งสัญญาณไปควบคุม Relay เพื่อตัด Contactor 
ทำให้ไม่สามารถ Override ได้ 
...
\begin{table}[H]
  ...
  \begin{tabular}{cclccl}
    \toprule
    Channel & ทิศทาง & สัญญาณ & ทิศทาง & STM32 Pin & Mode \\
    \midrule
    CH1 & Input  & Emergency Stop   & output   & PA5  & EXTI Interrupt \\
    CH2 & Input  & Proximity Sensor & output   & PA6  & GPIO Input \\
    CH3 & Input  & Mode Selector SW & output   & PA7  & GPIO Input \\
    CH4 & Input  & Reset Button     & output   & PB6  & GPIO Input \\
    CH5 & Input & ยังไม่กำหนด       & output    & PB12 & ยังไม่กำหนด \\
    CH6 & Input & ยังไม่กำหนด       & output    & PB11 & ยังไม่กำหนด \\
    CH7 & Input & ยังไม่กำหนด       & output    & PB2 & ยังไม่กำหนด \\
    CH8 & Input & ยังไม่กำหนด       & output    & PB1  & ยังไม่กำหนด \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lllll}
    ...
    PA11& CAN TD     & CAN1\_TD         & CAN Bus \\
    PA12& CAN RD     & CAN1\_RD         & CAN Bus \\
    \midrule
    ...
    PC3 & Reed Open  & GPIO Output      & Reed SW Open \\
    \midrule
    \multicolumn{4}{l}{\textit{Current Sensor}} \\
    PA0 & Analog Input & GPIO Input      & Current Sensor \\
    \bottomrule
  \end{tabular}
\end{table}
...
การสลับโหมดระหว่าง Joystick และ Base System
